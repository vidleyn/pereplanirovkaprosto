...
var mainControls = function (blueprint3d) {
  ...
  async function newDesign() {
    if (!myhome) {
      try {
        var response = await fetch("/planner/data/myhome.json");
...
var WallProperties = function () {
  this.textures = [
    ["/planner/rooms/textures/wallmap.png", true, 1],
    ["/planner/rooms/textures/wallmap_yellow.png", true, 1],
    ["/planner/rooms/textures/light_brick.jpg", false, 50],
    ["/planner/rooms/textures/marbletiles.jpg", false, 300],
    ["/planner/rooms/textures/light_brick.jpg", false, 100],
    ["/planner/rooms/textures/light_fine_wood.jpg", false, 300],
    ["/planner/rooms/textures/hardwood.png", false, 300],
  ];
