...
!(function (e, t) {
  ...
  function d(e) {
    (e.style.background = ""),
      (e.style.cssText +=
        "background: -moz-linear-gradient(top,  #008cba 0%, #ff00ff 17%, #0000ff 34%, #00ffff 50%, #00ff00 67%, #ffff00 84%, #008cba 100%);"),
      (e.style.cssText +=
        "background: -webkit-linear-gradient(top,  #008cba 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#008cba 100%);"),
      (e.style.cssText +=
        "background: -o-linear-gradient(top,  #008cba 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#008cba 100%);"),
      (e.style.cssText +=
        "background: -ms-linear-gradient(top,  #008cba 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#008cba 100%);"),
      (e.style.cssText +=
        "background: linear-gradient(top,  #008cba 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#008cba 100%);");
  }
  function c(e, t, n) {
